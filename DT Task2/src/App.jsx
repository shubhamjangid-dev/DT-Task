...
function App() {
  const [data, setData] = useState({
    ...
    isActive: true,
    lastposttime: 0,
    learning_outcomes: ["Bare minimum knowledge of project management", "4SA Concept", "Would be able to handle any project efficiently"],
    mainPid: 0,
    postcount: 0,
  ...
  // CORS error localhost is blocked
  ...
  if (data == null || data == {}) return <h1>Loading</h1>;
  return (
    <>
      <Board data={data} />
      <NoticeBoard />
